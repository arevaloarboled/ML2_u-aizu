function [ TrainImages, TrainLabels, TestImages, TestLabels ] = mnistread( root )
mnistfilenames={};
mnistfilenames{1} = strcat(root,'train-images-idx3-ubyte');
mnistfilenames{2} = strcat(root,'train-labels-idx1-ubyte');
mnistfilenames{3} = strcat(root,'t10k-images-idx3-ubyte');
mnistfilenames{4} = strcat(root,'t10k-labels-idx1-ubyte');
